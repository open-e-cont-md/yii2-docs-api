...
use openecontmd\docs_api\models\DocsInvoiceAPI;
 ...
 *              @OA\Examples(example="result_invoice", value={
 ...
 "controller": "invoice",
 "entry_point": "https://api.open.e-cont.md/docs/v1/invoice/{action}"
 }
...
/** Set Invoice Number
 * @OA\Post(
 *     path="/docs/v1/invoice/set-invoice-number",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
...
/** Set Issue Date
 * @OA\Post(
 *     path="/docs/v1/invoice/set-issue-date",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
...
/** Set Due Date
 * @OA\Post(
 *     path="/docs/v1/invoice/set-due-date",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact Name
 * @OA\Post(
 *     path="/docs/v1/invoice/set-contact-name",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact E-Mail
 * @OA\Post(
 *     path="/docs/v1/invoice/set-contact-email",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
...
/** Set Identifier
 * @OA\Post(
 *     path="/docs/v1/invoice/set-identifier",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
...
/** Create Invoice
 * @OA\Post(
 *     path="/docs/v1/invoice/create-invoice",
 *     method="post",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	public function actionCreateInvoice()
	{
	    ...
	    $r1 = DocsInvoiceAPI::checkInvoiceByNumber($id);
	    if ($r1) {
	        throw new HttpException(401, 'Повторный номер инвойса');
	    }
	    else {
	        $uid = DocsInvoiceAPI::createUid();
	        $r2 = DocsInvoiceAPI::createInvoice($uid, $id, $ubl_document);
	    }
 ...
 * @OA\Post(
 *     path="/docs/v1/invoice/create-invoice-by-object",
 *     tags={"docs"},
 ...
 * @OA\Post(
 *     path="/docs/v1/invoice/create-party-by-object",
 *     tags={"docs"},
...
/** Get Party By Id
 * @OA\Post(
 *     path="/docs/v1/invoice/get-party-by-id",
 *     method="post",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
 ...
 * @OA\Post(
 *     path="/docs/v1/invoice/get-invoice-by-number",
 *     method="post",
 *     tags={"docs"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	...
	{
	    $id = Yii::$app->request->get('id');
	    $r1 = DocsInvoiceAPI::getInvoiceByNumber($id);
