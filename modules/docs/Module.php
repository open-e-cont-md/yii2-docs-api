...
namespace openecontmd\docs_api\modules\docs;

use Yii;
use yii\filters\VerbFilter;
//use yii\web\BadRequestHttpException;
use openecontmd\docs_api\models\validation\ApiRequest;
use yii\web\HttpException;

class Module extends \yii\base\Module
{
	public $controllerNamespace = 'openecontmd\docs_api\modules\docs\controllers';
	public $gate = null;
...
//		$this->gate = Yii::$app->session->get('gate');
		...
		//$this->_check_token();
		//		$method = str_replace('docs/v1/', '', $this->module->requestedRoute);
